...
class VendingMachine{
	...
	vendBeverage(selectedChoice){
		 var charVal = selectedChoice.substring(0,1);
		 var numVal = selectedChoice.substring(1,2);
		 this.scene.letter = charVal;
		this.scene.number = numVal;
		this.getBeverage();
	}
	getBeverage(){
